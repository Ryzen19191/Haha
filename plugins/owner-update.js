...
let handler = async (_0x4bf81a, {
  ...
  try {
    await _0x4a093a.loadingMsg(_0x4bf81a.chat, "🔍 Checking for PRINCEAI updates...", "Starting update process...", ['▬▭▭▭▭▭', "▬▬▭▭▭▭", "▬▬▬▭▭▭", '▬▬▬▬▭▭', "▬▬▬▬▬▭", "▬▬▬▬▬▬"], _0x4bf81a);
    ...
    const {
      data: _0x3c4887
    } = await _0x42a341.get("https://api.github.com/repos/KASHMIRICRASHER/KASHMIRI-MD/commits/main");
    ...
    if (_0x2d77f1 === _0x55cc26) {
      return _0x4bf81a.reply("```✅ Your KASHMIRI-MD bot is already up-to-date!```");
    }
    const _0x1a3be7 = ["KASHMIRI-MD Bot Updating...🚀", "📦 Downloading the latest code...", "📦 Extracting the latest code...", "🔄 Replacing files...", "🔄 Restarting the bot to apply updates..."];
    ...
    const {
      data: _0xaf7662
    } = await _0x42a341.get("https://github.com/KASHMIRICRASHER/KASHMIRI-MD/archive/main.zip", {
    ...
    const _0x1ce39f = _0x5378e7.join(_0x2adf29, 'KASHMIRI-MD-main');
